-- Ensure pgcrypto extension is properly loaded
CREATE EXTENSION IF NOT EXISTS pgcrypto WITH SCHEMA public;

-- Fix Security Definer View Issue (already done in previous migration)
-- The safe_profiles view was already created correctly

-- Fix function search_path issues for all remaining functions
-- MFA encryption functions (simplified approach for now)
